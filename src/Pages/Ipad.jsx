...
export default function Ipad() {
  ...
  // const NavFunction=()=>{
  //   NavigateCard('/CardPage')
  // }
  const[data,setData]=useState([])
  useEffect(()=>{
    fetch("https://ecommerce-database-zepl-d65j69f9z-ramanakorada2611.vercel.app/ipadPage")
    .then(response=>response.json())
    .then(response=>setData(response.ipadPage))
  },[])
  return (
    <><br/>
    <div className='iphone-bar'>Ipad/Accesories</div><br/><br/>
    ...
    <div className='overall-iphone'>
     ...
     <div className='overall-iphone1'>
        ...
        <h2 className='blue-head'>Ipad</h2><br/>
