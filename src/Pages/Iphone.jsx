...
export default function Iphone() {
  ...
  useEffect(()=>{
    fetch("https://ecommerce-database-zepl-d65j69f9z-ramanakorada2611.vercel.app/iphonePage")
    .then(response=>response.json())
    .then(response=>setData(response.iphonePage))
  },[])

  return (
   <><br/>
    <div className='iphone-bar'>Iphone/Accesories</div><br/><br/>
