...
export default function Accesories() {
  ...
  useEffect(()=>{
    fetch("https://ecommerce-database-zepl-d65j69f9z-ramanakorada2611.vercel.app/accesoriesPage")
    .then(response=>response.json())
    .then(response=>setData(response.accesoriesPage))
  },[])
  return (
    <><br/>
    <div className='iphone-bar'>Accesories/Accesories</div><br/><br/>
    ...
    <div className='overall-iphone'>
     ...
     <div className='overall-iphone1'>
        ...
        <h2 className='blue-head'>Iphone 8 Plus</h2><br/>
